...
Encoder ready: embed_dim=768  load_time=11.6s
Loading BC head: weights\muzero\stage2_bc_seed1024_lfm\policy_head.pt
...
| Embed dim | 768 |
| Episodes | 25 |
| Encoder latency (mean / p95) | 14.5 ms / 14.3 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 20  (80%) |
| Action: skip   | 5   (20%) |
...
| Embed dim | 768 |
| Episodes | 26 |
| Encoder latency (mean / p95) | 13.3 ms / 14.2 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 22  (85%) |
| Action: skip   | 4   (15%) |
...
| Embed dim | 768 |
| Episodes | 33 |
| Encoder latency (mean / p95) | 13.4 ms / 15.1 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 26  (79%) |
| Action: skip   | 7   (21%) |
...
| Embed dim | 768 |
| Episodes | 84 |
| Encoder latency (mean / p95) | 13.8 ms / 14.6 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 68  (81%) |
| Action: skip   | 16   (19%) |
