...
Encoder ready: embed_dim=768  load_time=12.0s
Loading BC head: weights\muzero\stage2_bc_seed2026_lfm\policy_head.pt
...
| Embed dim | 768 |
| Episodes | 25 |
| Encoder latency (mean / p95) | 15.1 ms / 23.7 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 17  (68%) |
| Action: skip   | 8   (32%) |
...
| Embed dim | 768 |
| Episodes | 26 |
| Encoder latency (mean / p95) | 12.8 ms / 13.3 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 20  (77%) |
| Action: skip   | 6   (23%) |
...
| Embed dim | 768 |
| Episodes | 33 |
| Encoder latency (mean / p95) | 13.0 ms / 13.9 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 25  (76%) |
| Action: skip   | 8   (24%) |
...
| Embed dim | 768 |
| Episodes | 84 |
| Encoder latency (mean / p95) | 13.6 ms / 16.9 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 62  (74%) |
| Action: skip   | 22   (26%) |
