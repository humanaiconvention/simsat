...
Encoder ready: embed_dim=768  load_time=12.6s
Loading BC head: weights\muzero\stage2_bc_seed13\policy_head.pt
...
| Embed dim | 768 |
| Episodes | 25 |
| Encoder latency (mean / p95) | 15.0 ms / 16.9 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 18  (72%) |
| Action: skip   | 7   (28%) |
...
| Embed dim | 768 |
| Episodes | 26 |
| Encoder latency (mean / p95) | 13.7 ms / 14.8 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 18  (69%) |
| Action: skip   | 8   (31%) |
...
| Embed dim | 768 |
| Episodes | 84 |
| Encoder latency (mean / p95) | 13.9 ms / 15.5 ms |
| Action: accept | 0 (0%) |
| Action: refine | 0 (0%) |
| Action: defer  | 61  (73%) |
| Action: skip   | 23   (27%) |
